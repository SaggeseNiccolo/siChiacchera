    ...
    public void comunica() throws Exception {
        ...
        for (;;) {
            ...
            if (conta == 0) {
                ...
                System.out.println("SERVER: HO APPENA INVIATO A TUTTI UN MESSAGGIO");
                ...
                outVersoClient.writeBytes("Selezionato messaggio Privato, Destinatario: " + '\n');
                ...
                System.out.println("SERVER: HO APPENA INVIATO A " + destinatario + " UN MESSAGGIO");
